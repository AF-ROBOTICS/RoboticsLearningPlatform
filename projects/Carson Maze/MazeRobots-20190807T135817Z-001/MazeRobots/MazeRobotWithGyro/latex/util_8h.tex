...
\begin{DoxyCompactList}\small\item\em Combines accel\+Ramp and decel\+Ramp, switching from one to the other halfway between start and target. \end{DoxyCompactList}\item 
double \hyperlink{util_8h_aea8965091d8002e994bb9440aeaafdf5}{get\+Angle\+Diff} (double start, double target)
\begin{DoxyCompactList}\small\item\em Returns the signed difference between two angles. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
\mbox{\Hypertarget{util_8h_aea8965091d8002e994bb9440aeaafdf5}\label{util_8h_aea8965091d8002e994bb9440aeaafdf5}} 
\index{util.\+h@{util.\+h}!get\+Angle\+Diff@{get\+Angle\+Diff}}
\index{get\+Angle\+Diff@{get\+Angle\+Diff}!util.\+h@{util.\+h}}
\subsubsection{\texorpdfstring{get\+Angle\+Diff()}{getAngleDiff()}}
{\footnotesize\ttfamily double get\+Angle\+Diff (\begin{DoxyParamCaption}\item[{double}]{start,  }\item[{double}]{target }\end{DoxyParamCaption})}



Returns the signed difference between two angles. 

Returns the shortest angle change required to get from start to target. For example, if start is 20.\+0, and target is 350.\+0, the function returns -\/30.\+0, as that is the least angle change required to get from the starting angle to the target angle. 