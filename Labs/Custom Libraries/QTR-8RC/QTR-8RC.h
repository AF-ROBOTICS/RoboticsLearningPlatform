...
class QTRSensors
{
  public:
    ...
    ///
    /// See \ref md_usage for more information and example code.
    int16_t readLineBlack(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode::On)
    {
    ...
    ///
    /// See \ref md_usage for more information and example code.
    int16_t readLineWhite(uint16_t * sensorValues, QTRReadMode mode = QTRReadMode::On)
    {
  ...
  private:
    ...
    int16_t readLinePrivate(uint16_t * sensorValues, QTRReadMode mode, bool invertReadings);
