...
\begin{document}
	...
	Browse to \path{K:\DF\DFEC\ECE210\Labs\Lab 9 - Driving the Robot} and copy the \path{robot_drive} folder to your computer. Open \path{robot_drive.ino}. 
	
	
	Use Notepad++ to open the \textit{Motor.h} file that you previously saved here: \path{Program Files (x86)/Arduino/libraries/Motor/Motor.h}. The \textit{.h} file is a header file used within the \textit{.ino}  Arduino sketch. Take a look at \path{Motor.h} first.
