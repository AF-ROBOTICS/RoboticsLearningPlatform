...
\begin{document}
	...
	Use Notepad++ to open the \textit{Motor.h} file that you previously saved here:\\ \path{Documents/Arduino/libraries/Motor/Motor.h}. The \textit{.h} file is a header file used within the \textit{.ino}  Arduino sketch. Take a look at \path{Motor.h} first.
